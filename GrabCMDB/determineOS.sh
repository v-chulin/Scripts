########################################################################################
# Execute this script under a linux server ./serverlist.txt save all the servers.      #
...
do
# ping the server name grab the line with keyword "ttl", then split by "=" and get 3rd item, cut it with " ", then get the 1st item #
